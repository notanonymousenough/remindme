...
from ...schemas.reminder import ReminderSchemaToEditTime, ReminderMarkAsCompleteSchema
...
class ReminderRepository(BaseRepository[Reminder]):
    ...
    async def mark_as_completed(self, reminder: ReminderMarkAsCompleteSchema) -> Reminder:
