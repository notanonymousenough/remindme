...
def reminders_buttons(count_of_reminders: int, day: str, next = 0):
    ...
    if count_of_reminders > 5*(next+1):
        keyboard.row(InlineKeyboardButton(text="->", callback_data=f"reminder_next_{next+1}"))
